...
import styles from "./ShowClinicName.module.css"
const ShowClinicName = (props) => {
  return (
    <div className={styles.container}>
      ...
      <span>{props.doctorDetails.name} {props.doctorDetails.address}</span>
      </div>
    </div>
  );
};

export default ShowClinicName;
